...
- **값** — 정말 그 모양이면서 글자로 읽을 수 없는 것인가. base64 첨부는 **실제로
  디코드되는지**까지 봅니다. 모양을 흉내내는 정규식으로는 안 됩니다 — URL-안전
  알파벳이 하이픈을 포함하는 바람에 `880312-1068011-880312-…` 같은 한국 식별자가
  전부 "base64 모양"으로 판정됐습니다. **흉내낼 수 있는 조건은 조건이 아닙니다.**
